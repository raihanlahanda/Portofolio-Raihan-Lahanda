...
- Monitoring ATM secara online menggunakan sistem ATMON
- Analisa error berdasarkan log sistem
- Melakukan patching dan deployment file ke server
- Melakukan restart mesin ATM secara remote
- Memastikan update Electronic Journal (EJ) berjalan normal
- Koordinasi dengan Data Center untuk penanganan issue sistem
